$('.select2').select2()
import t from "../lang"
var route = `${window.location.origin}/api/settings/supplier`;
var route_show = `${window.location.origin}/setting/setting-supplier/show`;
...
const table = $('.table-supplier').DataTable({
    ...
    columns: [
        ...
        { data: 'Address', defaultContent: '', title: t('Address') },
        { data: 'Contact', defaultContent: '', title: t('Contact') },
        { data: 'Phone', defaultContent: '', title: t('Phone') },
