...
@section('content')
    @if (Auth::user()->checkRole('delete_master') || Auth::user()->level == 9999)
        @include('basic.modal_request_destroy', [
            'route' => route('masterData.groupMaterials.destroy'),
        ])
    @endif
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="tableGroupMaterials" width="100%">
                            <thead>
                                <th>{{ __('ID') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (Auth::user()->checkRole('update_master') || Auth::user()->level == 9999)
                                                <a href="{{ route('masterData.groupMaterials.show', ['ID' => $value->ID]) }}"
