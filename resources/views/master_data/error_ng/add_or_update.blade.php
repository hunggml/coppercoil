                    ...
                    <form role="from" method="post" action="#">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-4 hide">
                                    ...
                                    <input type="text" value="" class="form-control" id="idError" name="ID"
                                        readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="nameError">{{ __('Name') }} {{ __('Error') }}</label>
                                    <input type="text" value="" class="form-control" id="nameError" name="Name"
                                        placeholder="{{ __('Enter') }} {{ __('Name') }}" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="symbolsError">{{ __('Symbols') }} {{ __('Error') }}</label>
                                    <input type="text" value="" class="form-control" id="symbolsError"
                                        name="Symbols" placeholder="{{ __('Enter') }} {{ __('Symbols') }}" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="NoteError">{{ __('Note') }} {{ __('Error') }}</label>
                                    <input type="text" value="" class="form-control" id="NoteError" name="Note"
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" class="btn btn-success float-right"
                                style="width: 80px">{{ __('Save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
