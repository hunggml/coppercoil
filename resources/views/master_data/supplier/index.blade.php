	            ...
	            <div class="card">
	                <div class="card-header">
	                	...
	                	<div class="card-tools">
                        	...
                        	<a href="{{route('masterData.supplier.export_file',['Name'=>$request->Name,'Symbols'=>$request->Symbols])}}" class="btn btn-info " style="width: 180px">
		                		...
		                		@foreach($supplier as $value)
			                		<tr>
			                			...
			                			<td>
			                				...
			                				<a href="{{ route('masterData.supplier.show', ['ID' => $value->ID])}}" class="btn btn-success" style="width: 80px">
			                					{{__('Edit')}}
			                				</a>
			                				@endif
			               					@if(Auth::user()->checkRole('delete_master') || Auth::user()->level == 9999)
