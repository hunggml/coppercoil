    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{$route}}" method="post" name="fileImport" enctype="multipart/form-data">
          @csrf
          <input type="text" class="form-control hide" name="Product_ID" id="product_id">
          <div class="form-group">
            ...
            <span role="alert" class="hide error-file">
          ...
          <button type="submit" class="btn btn-success hide btn-submit-file">{{__('Submit')}}</button>
        </form>
      </div>
