<div class="modal fade" id="modalDetailWarehouse" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-detail" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Detail') }} {{ __('Location') }} : <span
                        id="nameWarehouse"></span></h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-4 hide">
                        ...
                        <input type="text" value="" class="form-control" id="idWarehouse" name="ID"
                            readonly>
                    </div>
            ...
            <span role="alert" class="hide error-unit">
              <strong style="color: red" class="error-unit"></strong>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" min="1" step="0.0000001" value="" class="form-control"
                            id="quantityPacking" name="Quantity_Packing"
                            placeholder="{{ __('Enter') }} {{ __('Quantity Packing') }}">
            ...
            <input type="number" value="0" class="form-control" id="minUnit" name="Min_Unit" placeholder="{{ __('Enter') }} {{ __('Quantity') }} {{ __('Min') }}">
                    ...
                    @if (false)
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" value="" class="form-control" id="note" name="Note"
