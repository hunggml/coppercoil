...
class MasterWarehouseDetail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Master_Warehouse_Detail', function (Blueprint $table) {
            $table->id('ID');
            ...
            $table->bigInteger('Position_Led')->default(0);
            $table->integer('R')->default(0)->nullable();
            $table->integer('G')->default(0)->nullable();
            $table->integer('B')->default(0)->nullable();
            $table->integer('Status_Led')->default(0)->nullable();
            $table->float('Quantity_Unit')->default(0)->nullable();
            $table->bigInteger('Unit_ID')->default(0)->nullable();
            $table->float('Min_Unit')->default(0)->nullable();
            $table->float('Quantity_Packing')->default(0)->nullable();
            $table->bigInteger('Packing_ID')->default(0)->nullable();
            $table->float('Min_Packing')->default(0)->nullable();
            ...
            $table->bigInteger('Point_ID')->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('Master_Warehouse_Detail');
    }
}
